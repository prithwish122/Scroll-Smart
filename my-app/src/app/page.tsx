...
const Home: FC = () => {
    ...
    return (
        <div
            ...
            style={{
                backgroundImage: `url(https://img.freepik.com/free-vector/abstract-blue-light-pipe-speed-zoom-black-background-technology_1142-9120.jpg?size=626&ext=jpg&ga=GA1.1.2008272138.1727049600&semt=ais_hybrid)`, // Replace with your image URL
            ...
            <div className="flex h-[100vh] pt-24">
                ...
                <div ref={heroRef} className="w-2/3 flex flex-col items-center justify-center text-center px-6">
                    <h1 className="text-7xl font-extrabold text-white shadow-md">
                        Unlock the Future of <span className="text-purple-400">Scroll Chain</span> with Your <span className="text-purple-400">AI Companion!</span>
                    </h1>
                </div>
            ...
            <div ref={descriptionRef} className="absolute w-1/2 mx-auto top-[80vh] left-16 p-6">
                ...
                >
                    ...
                    <p className="mt-4 text-xl leading-relaxed text-gray-300">
                        This Scroll Chain inquiry app is designed to revolutionize how users interact with blockchain technology, offering an engaging and personalized learning experience. With an AI-powered chatbot, users can delve into the intricacies of Scroll Chain, ask questions, and receive tailored explanations that suit their understanding.
                        <br />
                        <br />
                        Example prompts include:
                        <br />
                        <br />
                        👉 “What is Scroll Chain and how does it work?”<br />
                        👉 “How can I deploy smart contracts on Scroll Chain?”<br />
                        👉 “What are the benefits of using Scroll Chain over other blockchains?”<br />
                        👉 “Can you explain the scalability features of Scroll Chain?”<br />
                        👉 “What tools can I use for developing on Scroll Chain?”<br />
                        👉 “How does Scroll Chain enhance transaction speed and security?”<br />
                        <br />
                        This app aims to make blockchain knowledge accessible and enjoyable, breaking down barriers to understanding while fostering a curiosity for technology. By leveraging AI to provide instant support and resources, it empowers users to build their confidence and expertise in Scroll Chain, paving the way for informed decision-making and innovation in the blockchain space.
                    </p>
                </div>
            </div>
